...
[_QWERTY] = LAYOUT_void_ergo(
    ...
    KC_LSFT,    KC_Z,     KC_X,       KC_C,       KC_V,     KC_B,                     KC_N,       KC_M,       KC_COMM,     KC_DOT,      KC_SLSH,  KC_QUOT,
                KC_MPLY,  MO(_LOWER), KC_LGUI,    KC_LALT,  KC_SPC,                   KC_SPC,     KC_RALT,    KC_RGUI,     MO(_RAISE),  KC_MUTE
),
...
[_LOWER] = LAYOUT_void_ergo(
    ...
    KC_TRNS,    KC_LEFT,  KC_DOWN,    KC_RIGHT,   KC_NO,    KC_NO,                     KC_LEFT,    KC_DOWN,   KC_RIGHT,    KC_NO,       KC_TRNS,  KC_TRNS,
                KC_TRNS,  MO(_LOWER), KC_TRNS,    KC_TRNS,  KC_TRNS,                   KC_TRNS,    KC_TRNS,   KC_TRNS,     MO(_RAISE),  KC_TRNS
),
