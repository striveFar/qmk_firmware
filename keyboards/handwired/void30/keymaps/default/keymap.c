...
[_QWERTY] = LAYOUT_void_grid(
    ...
    LCTL_T(KC_Z),  LALT_T(KC_X),  LGUI_T(KC_C), LT(FN3, KC_V), LT(FN2, KC_BSPC), LT(FN1, KC_SPC), LT(FN4, KC_B), RALT_T(KC_N), RCTL_T(KC_M), RSFT_T(KC_ENT)
),
