...
[_LOWER] = LAYOUT_void_grid(
    ...
    KC_ESC,   TG(_CSGO),  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_MPLY, KC_MPLY, KC_TRNS,     KC_MPRV,    KC_VOLD, KC_VOLU, KC_MNXT
),
...
[_RAISE] = LAYOUT_void_grid(
    ...
    KC_CAPS,  KC_F7,    KC_F8,    KC_F9,    KC_F10,  KC_F11,  KC_F12,   KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, KC_TRNS,
