 ...
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_void_grid(
    KC_ESC,  KC_Q,          KC_W,    KC_E,    KC_R,       KC_T,     KC_Y,     KC_U,         KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_TAB,  KC_A,          KC_S,    KC_D,    KC_F,       KC_G,     KC_H,     KC_J,         KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,          KC_X,    KC_C,    KC_V,       KC_B,     KC_N,     KC_M,         KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,
    KC_LCTL, MO(_FUNCTION), KC_LGUI, KC_LALT, MO(_LOWER), KC_SPC,   KC_SPC,   MO(_RAISE),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_void_grid(
    ...
    KC_ESC,   TG(_CSGO),  KC_TRANS, KC_TRANS, KC_TRNS, KC_MPLY, KC_MPLY, KC_TRNS,     KC_MPRV,    KC_VOLD, KC_VOLU, KC_MNXT
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_void_grid(
    KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,    KC_5,    KC_6,     KC_7,    KC_8,    KC_9,    KC_0,    KC_TRANS,
    KC_DEL,   KC_F1,    KC_F2,    KC_F3,    KC_F4,   KC_F5,   KC_F6,    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    KC_CAPS,  KC_F7,    KC_F8,    KC_F9,    KC_F10,  KC_F11,  KC_F12,   KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, KC_TRANS,
    KC_TRANS, KC_TRANS, KC_TRANS, KC_TRANS, KC_TRNS, KC_MPLY, KC_MPLY,  KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
),

/* CSGO */

[_CSGO] = LAYOUT_void_grid(
    ...
    KC_ESC,   KC_TAB,   KC_NO,  KC_B, KC_NO,  KC_LCTL,  KC_LCTL,  KC_NO, KC_F3, KC_F4,  KC_F1,  KC_F2
),

/* Function */

[_FUNCTION] = LAYOUT_void_grid(
    KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_TRANS,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
),

/* Adjust */

[_ADJUST] =   LAYOUT_void_grid(
    RESET,    RGUI(KC_1),       RGUI(KC_2),       RGUI(KC_3),     RGUI(KC_4),     RGUI(KC_5),   RGUI(KC_6), RGUI(KC_7), RGUI(KC_8), RGUI(KC_9), RGUI(KC_0), KC_NO,
    KC_F14,   RGUI(KC_INS),     RGUI(KC_PGDN),    RGUI(KC_HOME),  RGUI(KC_PGUP),  KC_NO,        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
